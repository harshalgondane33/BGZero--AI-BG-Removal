    ...
    <div className='mx-4 min-h-[75vh] mt-14 lg:mx-44 my-3'>
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-2xl'>
        ...
        <div className='flex items-center justify-center sm:justify-end flex-wrap gap-4 mt-6'>
          ...
          <a className='px-8 py-2.5 text-white bg-gradient-to-r from-violet-700 to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700' href=''>Download Image</a>
        </div>
      </div>
    </div>
  )
