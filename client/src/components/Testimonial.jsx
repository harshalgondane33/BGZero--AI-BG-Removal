...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            title: 'UX Designer',
            message:
                "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odit commodi libero in, quas excepturi voluptas optio minima vero necessitatibus error!",
            image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&h=200&auto=format&fit=crop',
        },
    ];
  return (
    <div>
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-300 bg-clip-text text-transparent'>Customer Testimonials</h1>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center p-8 text-center">
                            <div className="mb-4 text-gray-500">
                                <h3 className="text-lg font-semibold text-gray-900 text-left px-10">❝</h3>
